...
$(".card .list-group").sortable({
  ...
  deactivate: function(event) {
    ...
    $(this.bottom-trash).removeClass("bottom-trash-drag");
  },
  over: function(event) {
...
// change color of task based on approaching due date
var auditTask = function(taskEl) {
  // get date from task element
  var date = $(taskEl).find("span").text().trim();
  
  // convert to moment object at 5:00pm since default is 12:00am
